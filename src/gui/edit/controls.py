                ...
                if len(commands) > 0:
                    ...
                    if new_index != c_index:
                        ...
                        edit.editor.create_edit_ui(
                            point.commands, new_index, commands.update_obj
                        )
                else:
                    if direction == "up":
                    ...
                    if new_index != p_index:
                        ...
                        edit.editor.create_edit_ui(
                            config.routine.sequence, new_index, components.update_obj
                        )
    ...
    def delete(self):
        ...
        if len(components) > 0:
            ...
            if len(commands) > 0:
                ...
                edit.editor.create_edit_ui(
                    config.routine.sequence, p_index, edit.routine.components.update_obj
                )
            else:
