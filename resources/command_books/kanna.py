"""A collection of all commands that a Kanna can use to interact with the
game."""
...
class Buff(Command):
    ...
    def main(self):
        ...
        if (
            self.buff_time == 0
            or now - self.buff_time > settings.buff_cooldown
        ):
            for key in buffs:
...
class Keypress1(Command):
    """Presses a Key in keypress #1"""

    def main(self):
        press(Key.KEY1, 1)


class Keypress2(Command):
    """Presses a Key in keypress #2"""

    def main(self):
        press(Key.KEY2, 1)


class Keypress3(Command):
    """Presses a Key in keypress #3"""

    def main(self):
        press(Key.KEY3, 1)


class Keypress4(Command):
    """Presses a Key in keypress #4"""
